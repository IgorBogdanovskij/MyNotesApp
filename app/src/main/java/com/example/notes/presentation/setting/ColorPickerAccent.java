...
//
//public class ColorPickerAccent implements IColorPickerAccent {
//    private int mColor;
...
//
//
//    public ColorPickerAccent(View view) {
//        mCheck = new ArrayList<>();
//        LinearLayout forOval = view.findViewById(R.id.forOvalSetting);
